  ...
  return (
    <Stack alignItems="center" justifyContent="center" mt="37px" p="20px" >
      ...
      <Box position="relative" mb="72px" >
        ...
        height="76px"  onChange={(e)=> setSearch(e.target.value.toLowerCase()) } placeholder="Search Exercises" value={search} type="text" />
        <Button onClick={handleSearch} className="search-btn" sx={{ bgcolor: '#FF2625', color: '#fff',
